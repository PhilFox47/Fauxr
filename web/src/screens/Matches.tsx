...
export default function Matches({
  ...
  const active = filtered.filter((m) => m.state !== 'blocked_by_char' && m.state !== 'blocked_by_user');
  const archived = filtered.filter((m) => m.state === 'blocked_by_char' || m.state === 'blocked_by_user');
