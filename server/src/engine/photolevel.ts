...
const PROFILE_LEVELS: Record<'bold' | 'flirty' | 'teasing', { name: string; shows: string; about: string; pose: string; look: string }> = {
  bold: {
    ...
    pose: 'Posed to show it off: back arched, looking back over a bare shoulder, stretched across the sheets, leaning in close to the lens, a hand on your own body.',
  ...
  flirty: {
    ...
    about: 'You out in the world looking good: a night out, after the gym, a pool, the mirror before you leave, your car, a festival.',
  ...
  teasing: {
    ...
    about: 'An everyday moment with an edge: in bed in the morning, curled up on the sofa, a close-up of your face, fresh out of the shower.',
